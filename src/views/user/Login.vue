  ...
  <div class="main">
    ...
    >
      ...
      <a-form-item>
        ...
        <a class="forge-password" style="float: right;" onclick="void(0)">{{ $t('user.login.forgot-password') }}</a>
      </a-form-item>
      ...
      <div class="user-login-other">
        ...
        <a>
          <a-icon class="item-icon" type="weibo"></a-icon>
        </a>
      </div>
    </a-form>
  </div>
  ...
  methods: {
    ...
    requestSuccess (res) {
      if (res['code'] === '0') {
        ...
        this.loginErrorMessage = res['msg'] || '登陆失败'
